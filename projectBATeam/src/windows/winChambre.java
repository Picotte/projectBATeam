...
public class winChambre extends winHeritage {
	...
	public boolean ModifActive = false;
...
//---------------ACTION DES BOUTON DE LA FRAME----------------------------
		btnAnnuler.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if(AjoutActive == true || ModifActive == true)
				{
					ModeConsultation();
				}
			}
		...
		btnEnregistrer.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				else if(ModifActive == true)
 					leControllerChambre.modifier(instance);
 			}
		});
		btnQuitter.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				if(AjoutActive == false && ModifActive == false)
				{
		...
		btnModifier.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				{
					ModeModifier();
					leControllerChambre.setModifMode();
				}
			}
		});
		...
		btnSupprimer.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if(AjoutActive == false && ModifActive == false)
				{
					leControllerChambre.supprimer(instance);
				}
			}
		});
...
//---------------ACTION DU MENU DE LA FRAME----------------------------
		...
		JMenuItem mntmRapportDesChambres = new JMenuItem("Rapport des Chambres");
		mntmRapportDesChambres.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				leControllerChambre.rapport();
			}
		});
		mnRapports.add(mntmRapportDesChambres);
